...
<div style="background-color:#45424a;padding:15px;text-align:center;">
  <h1> Locadora Hyuga</h1>
</div>
...
<div style="overflow:auto">
  ...
  <div class="main text-center">
    ...
    <h2>Venha conhecer a locadora Hyuga a locadora com melhores preços e promoções!!</h2>
...
<div style="background-color:#45424a;color:white;text-align:center;padding:10px;margin-top:7px;">© copyright from Gisely Fernanda Dias Pereira</div>
